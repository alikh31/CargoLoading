...
__BoxRow* temp = new __BoxRow();
	...
	lineEdit->setText(temp->Code);
	lineEdit_11->setText(temp->Color);
	lineEdit_2->setText(temp->Desc);
	lineEdit_8->setText(temp->FloorIndex);
	lineEdit_10->setText(QString(temp->MaxLoad));
	lineEdit_14->setText(QString(temp->PaleteSizeH));
	lineEdit_13->setText(QString(temp->PaleteSizeL));
	lineEdit_12->setText(QString(temp->PaleteSizeW));
